...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    ServerHandler *serverHandlerOperation = [[ServerHandler alloc] initWithURL:[NSURL URLWithString:@"http://staging.couponapitest.com/task_data.txt"] andRequestMethod:@"POST"];
